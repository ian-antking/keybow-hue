...
if __name__ == '__main__':
    ...
    keyboard_one.add_key(helpers.keys.build_decrease_hue_button(room, keyboard, 3))
    keyboard_one.add_key(helpers.keys.build_increase_hue_button(room, keyboard, 5))
